...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "YOOZOO AI")
if WEBUI_NAME != "YOOZOO AI":
    WEBUI_NAME += " (YOOZOO AI)"
...
DATA_DIR = Path("/home/yoozoo-ai/devin/test/volume/data").resolve()
...
WEBUI_AUTH_TRUSTED_COOKIES = "dataai_token"
